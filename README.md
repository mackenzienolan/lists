...
- [OpenAPI](https://www.openapis.org/) - API specification and tooling
...
- [MDN Web Docs](https://developer.mozilla.org/en-US/) - Comprehensive web development guides
...
- [Vercel Platform](https://vercel.com) - Deployment and hosting
- [Next.js Examples](https://github.com/vercel/next.js/tree/canary/examples) - Official examples

**Astro**

- [Astro Documentation](https://docs.astro.build) - Official documentation
- [Astro Themes](https://astro.build/themes/) - Community themes
- [Astro Integrations](https://astro.build/integrations/) - Official integrations

### Backend Frameworks

**Node.js**

- [Node.js Documentation](https://nodejs.org/en/docs/) - Official documentation
- [Express](https://expressjs.com/) - Popular web framework
- [Fastify](https://www.fastify.io/) - High-performance framework
- [NestJS](https://nestjs.com/) - Enterprise framework
- [Hono](https://hono.dev/) - Modern, lightweight framework
...
- [Storyblok](https://www.storyblok.com/) - Content management system
- [Prismic](https://prismic.io/) - Content management system

### Infrastructure

- [SST Documentation](https://docs.sst.dev/) - Official SST documentation
...
- [OpenAI](https://openai.com/) - Leading AI platform and APIs
- [Anthropic Claude](https://www.anthropic.com/claude) - Advanced AI assistant
- [Google Gemini](https://gemini.google.com/) - Multimodal AI model
- [Hugging Face](https://huggingface.co/) - AI model hub and tools

### Frameworks & Libraries

- [LangChain](https://www.langchain.com/) - LLM application framework
- [LangGraph](https://langchain.com/langgraph) - Graph-based LLM orchestration
...
- [Ahrefs](https://ahrefs.com/) - SEO tools suite

### CRM & Sales

- [HubSpot](https://www.hubspot.com/) - All-in-one CRM platform
- [Salesforce](https://www.salesforce.com/) - Enterprise CRM solution
- [Odoo](https://www.odoo.com/) - Open source CRM/ERP
- [Pipedrive](https://www.pipedrive.com/) - Sales-focused CRM

## Learning & Community

- [egghead.io](https://egghead.io/) - Developer video tutorials
- [Frontend Masters](https://frontendmasters.com/) - Advanced web development courses
- [Udemy](https://www.udemy.com/) - Online courses platform
